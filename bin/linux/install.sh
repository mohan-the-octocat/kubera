...
print_usage() {
  cat <<EOF
Usage: ./bin/linux/install.sh [OPTIONS]
...
Examples:
  ./bin/linux/install.sh                     # Global install (symlink)
  ./bin/linux/install.sh --copy              # Global install (copy files)
  ./bin/linux/install.sh -p /path/to/project # Project-scoped install
